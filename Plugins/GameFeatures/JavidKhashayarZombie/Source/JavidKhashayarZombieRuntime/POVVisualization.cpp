...
UPOVVisualization::UPOVVisualization()
{
	PrimaryComponentTick.bCanEverTick = true;
	PrimaryComponentTick.TickInterval = 0.016f;
}

void UPOVVisualization::BeginPlay()
{
	Super::BeginPlay();
}

void UPOVVisualization::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UPOVVisualization::DrawPOVCone()
{
	DrawDebugCone();
}

void UPOVVisualization::DrawDebugCone()
{
...
FVector UPOVVisualization::GetPawnForwardVector() const
{
