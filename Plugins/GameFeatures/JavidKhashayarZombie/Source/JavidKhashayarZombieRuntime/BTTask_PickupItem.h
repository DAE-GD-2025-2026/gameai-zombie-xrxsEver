...
UCLASS()
class JAVIDKHASHAYARZOMBIERUNTIME_API UBTTask_PickupItem : public UBTTaskNode
{
	GENERATED_BODY()
...
public:
	...
	virtual uint16 GetInstanceMemorySize() const override { return sizeof(FBTPickupItemMemory); }
